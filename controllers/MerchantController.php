...
class MerchantController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        $model = new MerchantUpdateForm($merchant);
        ...
        if ($model->load(Yii::$app->request->post())){
            try {
                ...
                // Run service
                (new MerchantService($merchant))->update($model);

                Yii::$app->session->setFlash('success', Yii::t('app', 'Merchant successfully updated'));
            } catch (Exception $e) {
     ...
     * @throws NotFoundHttpException
     */
    protected function findModel($id): Merchant
    {
