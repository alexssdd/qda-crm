...
/**
 * Class ReportOrderForm
 * @package app\forms\report
 */
class ReportOrderForm extends Form
{
    public $date_from;
    public $date_to;
    public $city_id;
    ...
    public function rules(): array
    {
        return [
            ...
            [['date_from', 'date_to', 'city_id', 'channel', 'delivery_method', 'payment_method', 'handler_id', 'status'], 'safe'],
        ];
    }
    ...
    public function attributeLabels(): array
    {
        return [
            ...
            'delivery_method' => Yii::t('app', 'Deliver Method'),
    ...
    {
        $query = Order::find()
            ->with(['histories', 'stores.orderStoreProducts']);
